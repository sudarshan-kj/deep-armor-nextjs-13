      ...
      <p>
        ...
        <ol>
          <ListItemWithTopMargin>
            <b>Security Development Life Cycle (SDLC)</b>: This course is
            relevant to all facets of product development and beneficial to
            executives, architects, developers, QA engineers and program
            managers. We cover the essentials of a 5-Step SDLC framework, the
            inputs and outputs at each stage, and have the attendees implement
            the learnings on sample projects. Students learn how to design and
            implement an SDLC framework for their own products and platforms.
            This course is beneficial for professionals whose employers do not
            have a mature internal SDLC process.
          </ListItemWithTopMargin>
          <ListItemWithTopMargin>
            <b> Cloud & Web Application Security</b>: The purpose of this
            training is to increase awareness among software developers,
            architects and validation engineers about cybersecurity pitfalls
            while developing, testing and deploying web applications on
            public/third-party cloud environments. They will understand how
            vulnerabilities manifest and may be exploited, and how to design
            secure systems to avoid such weaknesses. The training program
            includes plenty of hands-on activities, including lab exercises to
            learn practical exploitation of OWASP Top 10 vulnerabilities. We
            conclude with a Capture The Flag (CTF) competition. Attendees are
            required to “hack” a web application hosted by Deep Armor and gain
            points when they exploit a vulnerability.
          </ListItemWithTopMargin>
          <ListItemWithTopMargin>
            <b> Securing Internet of Things (IoT)</b>: This is one of our highly
            rated training programs, which has been accepted at Black Hat USA
            three times, as well as at numerous international events. A hands-on
